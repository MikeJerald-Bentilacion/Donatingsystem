   ...
   echo  '<header class="header">
        ...
        <div id="editProfileModal" class="modal fade">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                while($row = mysqli_fetch_array($user)){
                                    echo '
                                        <div class="form-group">
                                            <label>Name:</label>
                                            <input name="txt_name" id="txt_username" class="form-control input-sm" type="text" value="'.$row['name'].'" />
                                        </div>
                                        <div class="form-group">
                            ...
                            elseif($_SESSION['role'] == "Rider"){
                                $user = mysqli_query($con,"SELECT * from rider where id = '".$_SESSION['userid']."' ");
                                while($row = mysqli_fetch_array($user)){
                                    echo '
                                        <div class="form-group">
                                            <label>Name:</label>
                            ...
                            elseif($_SESSION['role'] == "Donor"){
                                $user = mysqli_query($con,"SELECT * from donor where id = '".$_SESSION['userid']."' ");
                                while($row = mysqli_fetch_array($user)){
                                    echo '
                                        <div class="form-group">
                                            <label>Name:</label>
            ...
            if(isset($_POST['btn_saveeditProfile'])){
                ...
                if($_SESSION['role'] == "Administrator"){
                    $updadmin = mysqli_query($con,"UPDATE user set username = '$username', password = '$password', name = '$name' where id = '".$_SESSION['userid']."' ");
                    if($updadmin == true){
                        header ("location: ".$_SERVER['REQUEST_URI']);
                    }
                }
                elseif($_SESSION['role'] == "Rider"){
                    $updrider = mysqli_query($con,"UPDATE rider set username = '$username', password = '$password', name = '$name' where id = '".$_SESSION['userid']."' ");
                    if($updrider == true){
                        header ("location: ".$_SERVER['REQUEST_URI']);
                    }
                }
                elseif($_SESSION['role'] == "Donor"){
                    $upddonor = mysqli_query($con,"UPDATE donor set username = '$username', password = '$password', name = '$name' where id = '".$_SESSION['userid']."' ");
                    if($upddonor == true){
                        header ("location: ".$_SERVER['REQUEST_URI']);
                    }
                }
