        ...
        <div class="modal-dialog modal-sm" style="width:300px !important;">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="txt_phone" class="form-control input-sm" type="int" placeholder="Phone Number"/>
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm" name="btn_add" id="btn_add" value="Add Donor"/>
                </div>
            </div>
        </div>
    </form>
