  ...
  <div class="modal-dialog modal-sm" style="width:300px !important;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Edit Donor Info</h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label>Name:</label>
                    <input name="txt_edit_name" class="form-control input-sm" type="text" placeholder="Lastname, Firstname Middlename" value="'.$row['name'].'"/>
                </div>
                <div class="form-group">
                    <label>Address:</label>
